...
reader = dv.io.MonoCameraRecording("/home/qiangubuntu/research/dv-processing/test_davis/data/0408/5.aedat4")
# print(f"EventResolution = {reader.getEventResolution()}")
...
def display_preview(data):
    ...
    if len(frames) > 0:
        ...
        # print(f"channel of frames.image: {len(frames[-1].image.shape)}") # 2
    ...
    if len(events) > 0:
        ...
        # print(f"latest_image.shape: {latest_image.shape}") # latest_image.shape: (260, 346, 3)
